  ...
  const loadLeaderboard = async () => {
    try {
      ...
      const leaderboardData = drafts.map(draft => {
        ...
        // If no predictions at all, return 0
        if (Object.keys(players).length === 0 && Object.keys(winnerPredictions).length === 0) {
          return {
            ...draft,
            totalScore: 0,
            breakdown,
        ...
        // Check batsman predictions - ONLY for matches they predicted
        ...
        // Check bowler predictions - ONLY for matches they predicted
        for (const key in players) {
          const parts = key.split('-')
          if (parts.length !== 2) continue
        ...
        // Check match winner predictions - ONLY for matches they predicted
        ...
        {leaderboard.length === 0 ? (
          ...
          <div className="space-y-4">
              ...
              {leaderboard.slice(0, 3).map((draft, index) => (
                ...
                >
                  ...
                  <p className="text-sm opacity-90 mb-2">
                    {draft.playersSelected + draft.winnersSelected} predictions
                  </p>
              ...
              <table className="w-full">
                <thead className="bg-blue-600 text-white">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-center font-bold">Predictions</th>
                ...
                <tbody>
                  {leaderboard.map((draft, index) => {
                    ...
                    const hasPredictions = draft.playersSelected + draft.winnersSelected > 0
            ...
            <div className="bg-purple-50 p-4 rounded-lg text-sm text-purple-700 text-center">
              📊 Only matches you predicted are scored. Make predictions for all matches to maximize your score!
            </div>
